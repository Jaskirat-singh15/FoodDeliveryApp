    ...
    return (
        <motion.div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col items-start justify-start gap-6">
                ...
                <p className="text-[40px] md:text-[72px] font-sans font-extrabold tracking-wider text-headingColor">
...
text-textColor">
                            ...
                            <p className="text-[12px] text-center md:text-base text-lighttextGray font-semibold capitalize"> {data.product_category}
                            </p>
